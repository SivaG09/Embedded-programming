...
{ 
    ...
    while(1)
    {
        ...
        CCP1CON = (CCP1CON&0x0C)+((voltage&0x03)<<4);   //logic to store the 5:4 bit of CCP1CON
...
void lcdinit()
{
 TRISA = 0x01;    //setting PORT A as input    
 ...
 ADCON1 = 0x8E;   //configuring ADCON1 register for 10000010, Selecting correct bit configuration and frequency
